                ...
                <div class="testimonial-content">
                    ...
                    <?php if (!empty($content['content_testimonial'])): ?>
						<div class="testimonial-entry-content">
							<?php
								$content = get_extended( $content['content_testimonial'] );

								if( ! empty( $content['main'] ) ) {
									printf( '<div class="testimonial-content-main">%s</div>', do_shortcode( $content['main'] ) );
								}

								if( ! empty( $content['extended'] ) ) {
									printf( '<label><input type="checkbox"><div class="testimonial-content-extended">%s</div><a href="#">%s</a></label>'
										, do_shortcode( $content['extended'] )
										, ! empty( $content['more_text'] ) ? $content['more_text'] : esc_attr__( 'More', 'themify' ) );
								}
							?>
						</div>
                    <?php endif; ?>
