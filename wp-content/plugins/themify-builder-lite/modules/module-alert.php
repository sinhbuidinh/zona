...
class TB_alert_Module extends Themify_Builder_Component_Module {
	...
	public function get_styling() {
		$general = array(
			...
			// Font
                        ...
                        self::get_color(array( '.module-alert', '.module-alert h1', '.module-alert h2', '.module-alert h3', '.module-alert h4', '.module-alert h5', '.module-alert h6', '.module-alert .alert-button' ),'font_color',__('Font Color', 'themify')),
	...
	protected function _visual_template() {
		...
		<div class="module module-<?php echo $this->slug ; ?> ui {{ data.layout_alert }} {{ data.color_alert }} {{ data.css_alert }} {{ data.background_repeat }} <# ! _.isUndefined( data.appearance_alert ) ? print( data.appearance_alert.split('|').join(' ') ) : ''; #>">
			<!--insert-->
